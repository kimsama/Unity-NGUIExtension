//////////////////////////////////////////////////////////////////////////
// GrayScale-AlphaMasked 1.shader
//
// NGUI shader for unlit grayscale sprite with alpha mask which is used in 
// UIDrawCall has clip count 1.
//
// (c) 2015 hwkim
//////////////////////////////////////////////////////////////////////////

Shader "Hidden/Unlit/GrayScale-AlphaMasked 1"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 fragmentProgram (vertexToFragment input) : COLOR
			{
    			...
    			base.rgb = lerp(base.rgb, dot(base.rgb, float3(0.3, 0.59, 0.11)), _EffectAmount);
    			half4 col = base;
